...
class SciHub(object):
    ...
    def download_pdf(self, pdf):
        ...
        if self.is_captcha_page(res):
            print(STD_WARNING + 'Failed: ' + self.doi)
            out = open('DOI-Failed.txt', 'a')
            out.write(self.doi)
            out.close()
            return 0
    ...
    def process_captcha_code(self, html, pdf):
        ...
        for i in range(10):
            ...
            if self.is_captcha_page(res):
                ...
                return res
        print(STD_WARNING + 'I have tried it 10 times but it did not work. Please download this file manually.')
        return res
